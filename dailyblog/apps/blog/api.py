...
def certainarticle(request):
    ...
    hottest, latest_articles= decorator(Article.get_hottest_articles()),decorator(Article.get_latest_articles())
    result.setdefault('hottest_articles',hottest)
    result.setdefault('latest_articles',latest_articles)
    carousel_page_list = latest_articles[:5]
    result.setdefault('carousel_page_list',carousel_page_list)
    result.setdefault('mydairy',decorator(Article.get_articles_by_cat(10)))
    result.setdefault('mydjango',decorator(Article.get_articles_by_cat(3)))
    result.setdefault('mingren',decorator(Article.get_articles_by_cat(26)))
    result.setdefault('myweb',decorator(Article.get_articles_by_cat(4)))
    result.setdefault('youxiu',decorator(Article.get_articles_by_cat(27)))
    result.setdefault('jingdian',decorator(Article.get_articles_by_cat(25)))
