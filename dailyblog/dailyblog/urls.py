...
from apps.blog.views import ArticleDetailView,CategoryArticleListView,TagArticleListView, \
    IndexView,WechatView,AuthorView
...
urlpatterns = [
    ...
    url(r'^wechat/hbnnforever/',WechatView.as_view(),name='wechat_auth'),
    url(r'^send_msg/','apps.blog.views.send_wechat_msg',name='send_wechat_msg'),
