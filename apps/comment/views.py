...
import logging
from ..blog.tasks import inform_commenter
...
class CreateCommentView(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if reply == '1':
            ...
            receiver = comment.reply_to.email
        else:
        ...
        #send mail to reply_to,inform them to lookup comment.
        article = Article.objects.filter(pk=articleid)
        inform_commenter.delay(article[0].alias,receiver)
