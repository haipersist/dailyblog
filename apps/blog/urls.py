...
from .viewset import CategoryViewset,ArticleViewset,UserViewset,\
        OnlineArticleViewset,VisitIpViewset,VisitPvViewset,JobViewset,CompanyViewset,\
        AuthorCommentViewset,CommentViewset,ReplyCommentViewset,VisitUvViewset
...
router.register(r'visitip',VisitIpViewset)
router.register(r'visitpv',VisitPvViewset)
router.register(r'visituv',VisitUvViewset)
